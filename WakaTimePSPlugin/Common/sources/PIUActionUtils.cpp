...
// a debug build:
	...
	if (event < SmallestHashValue)
	{
		...
		strncpy(eventIDAsString, "runtimeEventID", maxHashStringSize);
		eventIDAsString[maxHashStringSize-1] = '\0';
	}
...
static void DumpInfoFromReference(PIActionReference  inputRef, ofstream & fileOut)
{
	...
	while (inputRef)
	{
		...
		if (desiredClass < SmallestHashValue)
		{
			...
			strncpy(desiredClassStr, "runtimeClassID", maxHashStringSize);
			desiredClassStr[maxHashStringSize-1] = '\0';
		}
		...
		switch(formType)
		{
			...
			case formClass:
				...
				if (classValue < SmallestHashValue)
				{
					...
					strncpy(cvString, "runtimeClassID", maxHashStringSize);
					cvString[maxHashStringSize-1] = '\0';
				}
			...
			case formEnumerated:
				...
				if (enumTypeID < SmallestHashValue)
				{
					...
					strncpy(enumTypeIDStr, "runtimeTypeID", maxHashStringSize);
					enumTypeIDStr[maxHashStringSize-1] = '\0';
				}
				...
				if (enumID < SmallestHashValue)
				{
					...
					strncpy(enumIDStr, "runtimeEnumID", maxHashStringSize);
					enumIDStr[maxHashStringSize-1] = '\0';
				}
			...
			case formProperty:
				...
				if (propID < SmallestHashValue)
				{
					...
					strncpy(propIDStr, "runtimePropID", maxHashStringSize);
					propIDStr[maxHashStringSize-1] = '\0';
			...
			default:
				...
				if (formType < SmallestHashValue)
				{
					...
					strncpy(formTypeStr, "runtimeTypeID", maxHashStringSize);
					formTypeStr[maxHashStringSize-1] = '\0';
				}
		...
		switch (typeID)
		{
			...
			case typeUnitFloat:
				...
				if (unitID < SmallestHashValue)
				{
					...
					strncpy(unitIDStr, "runtimeUnitID", maxHashStringSize);
					unitIDStr[maxHashStringSize-1] = '\0';
				}
			...
			case typeObject:
				...
				if (objClassID < SmallestHashValue)
				{
					...
					// Update for the string
					strncpy(objClassIDStr, "runtimeClassID", maxHashStringSize);
					objClassIDStr[maxHashStringSize-1] = '\0';
			...
			case typeGlobalObject:
				...
				if (globObjClassID < SmallestHashValue)
				{
					...
					// Update for the string
					strncpy(globObjClassIDStr, "runtimeClassID", maxHashStringSize);
					globObjClassIDStr[maxHashStringSize-1] = '\0';
			...
			case 'enum'://typeEnumerated:
				...
				if (enumValue < SmallestHashValue)
				{
					...
					strncpy(enumValueStr, "runtimeEnumID", maxHashStringSize);
					enumValueStr[maxHashStringSize-1] = '\0';
				}
				...
				if (enumType < SmallestHashValue)
				{
					...
					strncpy(enumTypeStr, "runtimeTypeID", maxHashStringSize);
					enumTypeStr[maxHashStringSize-1] = '\0';
				}
			...
			case typeGlobalClass:
				...
				if (globClassID < SmallestHashValue)
				{
					...
					strncpy(globClassIDStr, "runtimeClassID", maxHashStringSize);
					globClassIDStr[maxHashStringSize-1] = '\0';
				}
			...
			default:
				...
				if (typeID < SmallestHashValue)
				{
					...
					strncpy(typeIDStr, "runtimeTypeID", maxHashStringSize);
					typeIDStr[maxHashStringSize-1] = '\0';
				}
								   ...
								   ofstream & fileOut)
{
	...
	while (counter < descCount)
	{
		...
		if (thisKeyID < SmallestHashValue)
		{
			...
			strncpy(keyIDStr, "runtimeKeyID", maxHashStringSize);
			keyIDStr[maxHashStringSize-1] = '\0';
		}
		...
		switch (typeID)
		{
			...
			case typeObject:
				...
				if (objClassID < SmallestHashValue)
				{
					...
					// Update for the string
					strncpy(objClassIDStr, "runtimeObjID", maxHashStringSize);
					objClassIDStr[maxHashStringSize-1] = '\0';
			...
			case typeGlobalObject:
				...
				if (globObjClassID < SmallestHashValue)
				{
					...
					// Update for the string
					strncpy(globObjClassIDStr, "runtimeObjID", maxHashStringSize);
					globObjClassIDStr[maxHashStringSize-1] = '\0';
	...
	if (!found)
	{
	    for (int32 counter = 0; counter < ArraySize; counter++)
    	    if (PSConstA[counter].longVal == inputLong)
				...
				{
					strncpy(returnString, PSConstA[counter].strStr, maxStringSize);
					returnString[maxStringSize-1] = '\0';
